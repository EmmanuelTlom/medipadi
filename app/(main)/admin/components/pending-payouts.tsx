...
import { approvePayout, getPendingPayouts } from '@/lib/requests/payouts';
...
export function PendingPayouts() {
  ...
  let { update, loading, data, page, total, pageCount, isLastPage, refresh } =
    usePagination(getPendingPayouts(), {
      immediate: true,
      initialPageSize: 10,
  ...
  const { loading: approving, fn: submitApproval } = useFetch(
    async (payoutId) => {
  ...
  const confirmApproval = async () => {
    if (!selectedPayout || approving) return;

    try {
      await submitApproval(selectedPayout.id);
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <h3 className="font-medium text-white">
                            {payout.doctor.firstName} {payout.doctor.lastName}
                          </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-white">
                      {selectedPayout.doctor.firstName}{' '}
                      {selectedPayout.doctor.lastName}
                    </p>
                  </div>
                  <div>
                ...
                <AlertDescription>
                  ...
                  <ul className="mt-2 space-y-1 list-disc pl-4">
                    <li>
                      ...
                      {selectedPayout.doctor.firstName}{' '}
                      {selectedPayout.doctor.lastName}'s account
                    </li>
